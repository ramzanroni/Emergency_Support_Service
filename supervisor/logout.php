...
$supervisorHistoryRecord=mysqli_query($conn, "INSERT INTO `history_supervisor`(`supervisor_id`, `sessionID`, `super_name`, `login_status`) VALUES ('".$_SESSION['userId']."', '".$_SESSION['sessionID']."','".$_SESSION['firstName']."','logout')");
